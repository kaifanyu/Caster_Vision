#!/usr/bin/env python
"""Run synthetic validation Stages A-E and print the hard-gate summary."""
...
from synthetic.validate import DEFAULT_SEED, format_summary_table, run_validation
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="pipeline YAML configuration (normally config.example.yaml)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=None,
        help="artifact directory (default: <config directory>/out/synthetic)",
    )
    parser.add_argument(
        "--quick",
        action="store_true",
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Synthetic validation assumptions:")
